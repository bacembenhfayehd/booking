...
export default function PlacesFormPage(){
    ...
    useEffect(() => {
     ...
     function inputHeader(text){
        return(
            <h2 className="mt-4 text-xl" >{text}</h2>
        )
    }
    ...
    async function savePlace(ev){
        ...
        const placeData = {title,address,description,
            addedPhotos,extraInfo,perks,checkIn,
        ...
        <div>
            <AccountNav/>
                            <form onSubmit={savePlace}>
                                {preInput('title','Title for your place should be short and catchy as advertissement')}
