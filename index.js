...
const jwtSecret = 'fezFIORGOIBOPezfkE¨P' ; 
...
app.post('/upload-by-link', async (req, res) => {
  const { link } = req.body;
  const newName = 'photo' + Date.now() + '.jpg'; // Ajout de l'extension .jpg

  try {
    await imageDownloader.image({
      url: link ,
      dest: __dirname + '/uploads/' + newName, // Ajout du slash entre les répertoires
    });
    res.json(newName);
  } catch (error) {
